...
// WhatsApp WebSocket connections above all) must therefore hang off
// globalThis rather than off module scope, or a single file save would
// orphan a running connection and force a fresh QR scan.
